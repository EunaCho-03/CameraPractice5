...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_camerapractice5_MainActivity_detectFace(JNIEnv *env, jobject thiz, jbyteArray in,
                                                         jbyteArray face, jint width, jint height, jstring cascadeFilePath) {
    jbyte* buf_ptr1 = env->GetByteArrayElements(in, nullptr);
    jbyte* buf_ptr2 = env->GetByteArrayElements(face, nullptr);
    const char* filePath;
    if(cascadeFilePath == nullptr)
        filePath = nullptr;
    else
